...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:MŔ_ĐĘVÎĹ
	    time.sleep(2)
            loop = 'false'
        else:
...
def pilog():
    ...
    if og =="1":
        ...
        print ("\033[1;96mPara")
        print (" ")
        print ("\033[1;95mItzz Sonu")
        print (" ")
        print ("\033[1;94mMajid")
        print (" ")
        print ("\033[1;93mOwner Of DFG")
        print
...
def crapil():
	...
	print "\033[1;95m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•\033[1;91mDevil King\033[1;95m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•"
	print "  \033[1;91m«---•◈•---Developed By Itzzz  Sono--•◈•---»" #Dev:MŘ_ĐĔVĪŁ
